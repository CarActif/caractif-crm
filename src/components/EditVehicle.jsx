...
export default function EditVehicle() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await supabase
      ...
      .update({
        ...form,
        couleur: form.couleur === "Autre" && form.couleur_interieure ? form.couleur_interieure : form.couleur,
        couleur_interieure:
          form.couleur_interieure === "Autre" && form.couleur_interieure
            ? form.couleur_interieure
            : form.couleur_interieure,
        photo_url: [...(form.photo_url || []), ...photoUrls],
    ...
    if (!error) {
      ...
      setSuccessMessage("Erreur lors de l’enregistrement !");
    }
  };
